    ...
    <form name="BackFromShablon">
      <div className="shablonShow">
        ...
        <div>
          ...
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task1} />{' '}
              Наставник выдал мне пропуск
            </div>
          </div>
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task2} />
              Наставник сообщил пароль от Wi-Fi
            </div>
          </div>
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task3} />
              Системный администратор выдал мне ноутбук
            </div>
          </div>
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task4} />
              Системный администратор выдал мне доступы к почте
            </div>
          </div>
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task5} />
          ...
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task6} />
              Ты познакомился (-ась) со своим руководителем
            </div>
          </div>
          <div className="check">
            <div>
              <input type="checkbox" name="task10" defaultChecked={el.task7} />
              Ты написал(-а) сообщение в командный чат
            </div>
          </div>
          <div className="check">
            <div>Напиши имена трех твоих коллег по отделу: {el.task8}</div>
